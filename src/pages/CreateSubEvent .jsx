...
import { Calendar, Clock, MapPin, Upload, User, Globe, ArrowLeft } from 'lucide-react';
...
const CreateSubEvent = () => {
  ...
  useEffect(() => {
    const fetchMainEvent = async () => {
      try {
        ...
        // Pre-fill some fields based on main event
        setFormData(prev => ({
          ...prev,
        ...
        toast.error("Failed to load main event information");
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Insert sub-event data into the SubEvents table
      ...
      // Navigate to sub-events page after short delay
      setTimeout(() => {
        navigate(`/events/${mainEventId}/subevents`);
      }, 2000);
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white px-4 py-8">
      ...
      <div className="max-w-3xl mx-auto relative">
        {/* Back button */}
        <button
          onClick={() => navigate(`/events/${mainEventId}/subevents`)}
        ...
        {mainEvent && (
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">
              Add Sub-Event to {mainEvent.event_name}
            </h1>
            <p className="text-center text-gray-400 mt-2">
              Create a new activity or competition within this main event
            </p>
          </div>
        )}
