...
import { Calendar, Clock, MapPin, CircleDollarSign, ChevronDown, ChevronUp } from "lucide-react"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto mb-16 relative">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-400 mb-8">Discover and join amazing events from university clubs</p>
          <input
            type="text"
      ...
      <div className="max-w-7xl mx-auto mb-12">
        ...
        {filteredUpcomingEvents.length === 0 && (
          <p className="text-center text-gray-400 py-10">No upcoming events found</p>
        )}
